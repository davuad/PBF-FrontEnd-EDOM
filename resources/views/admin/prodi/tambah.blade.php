...
<body class="font-poppins text-[#0A090B]">
    <section id="content" class="flex">
        ...
        <div id="menu-content" class="flex flex-col w-full pb-[30px]">
            ...
            <h1 class="text-2xl font-bold mb-6">Tambah Program Studi</h1>

            <form method="POST" action="{{ route('admin.prodi.simpan') }}" class="flex flex-col gap-[30px] w-[500px]">
              @csrf
              ...
              <div class="flex flex-col gap-[10px]">
                ...
                <div class="flex items-center h-[52px] p-[14px_16px] rounded-full border border-[#EEEEEE]">
                  <input type="text" name="nama_prodi" placeholder="Contoh: Struktur Data" value="{{ old('nama_prodi') }}" class="font-semibold placeholder:text-[#7F8190] placeholder:font-normal w-full outline-none" required>
                </div>
