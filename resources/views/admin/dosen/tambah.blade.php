...
<section id="content" class="flex">
  ...
  <div class="p-10 w-full">
    ...
    <form method="POST" action="{{ route('admin.dosen.simpan') }}" class="flex flex-col gap-[30px] w-[500px]">
      @csrf
      ...
      <div class="flex flex-col gap-[10px]">
        ...
        <div class="flex items-center h-[52px] p-[14px_16px] rounded-full border border-[#EEEEEE] transition-all duration-300 focus-within:border-2 focus-within:border-[#0A090B]">
          ...
          <input type="text" name="nidn" placeholder="Masukkan NIDN" class="font-semibold placeholder:text-[#7F8190] placeholder:font-normal w-full outline-none" required>
        </div>
      </div>
      ...
      <div class="flex flex-col gap-[10px]">
        ...
        <div class="flex items-center h-[52px] p-[14px_16px] rounded-full border border-[#EEEEEE] transition-all duration-300 focus-within:border-2 focus-within:border-[#0A090B]">
          ...
          <input type="text" name="nama_dosen" placeholder="Masukkan nama lengkap" class="font-semibold placeholder:text-[#7F8190] placeholder:font-normal w-full outline-none" required>
        </div>
      </div>
...
<div class="flex flex-col gap-[10px]">
    ...
    <div class="flex items-center h-[52px] p-[14px_16px] rounded-full border border-[#EEEEEE] focus-within:border-2 focus-within:border-[#0A090B]">
        ...
        <select name="id_matkul" id="matkulSelect" class="font-semibold w-full outline-none bg-transparent" required>
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    fetch("http://localhost:8080/api/prodi/getAll")
        ...
        .catch(error => console.error("Error ambil data prodi:", error));

    // Ambil Mata Kuliah
    fetch("http://localhost:8080/api/matkul/getAll")
        .then(response => response.json())
        .then(data => {
        ...
        .catch(error => console.error("Error ambil data matkul:", error));
});
</script>
